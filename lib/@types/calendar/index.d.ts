...
interface BaseExternalAccountClient { }
...
namespace GoogleAPI {
  ...
  export class Schema$CalendarList {
    /**
     * ETag of the collection.
     */
    etag?: string | null;
  ...
  export class Schema$CalendarListEntry {
    /**
  ...
  export class Schema$CalendarNotification {
    /**
  ...
  export class Schema$ColorDefinition {
    /**
  ...
  export class Schema$ConferenceData {
    /**
  ...
  export class Schema$ConferenceParameters {
    /**
     * Additional add-on specific data.
     */
    addOnParameters?: Schema$ConferenceParametersAddOnParameters;
  }
  export class Schema$ConferenceParametersAddOnParameters {
    parameters?: {[key: string]: string} | null;
  }
  export class Schema$ConferenceProperties {
    /**
  ...
  export class Schema$ConferenceRequestStatus {
    /**
  ...
  export class Schema$ConferenceSolution {
    /**
  ...
  export class Schema$ConferenceSolutionKey {
    /**
  ...
  export class Schema$CreateConferenceRequest {
    /**
  ...
  export class Schema$EntryPoint {
    /**
  ...
  export class Schema$EventAttachment {
    /**
  ...
  export class Schema$EventAttendee {
    /**
  ...
  export class Schema$EventDateTime {
    /**
  ...
  export class Schema$EventReminder {
    /**
  ...
  export class Schema$FreeBusyCalendar {
    /**
  ...
  export class Schema$FreeBusyGroup {
    /**
  ...
  export class Schema$FreeBusyRequest {
    /**
  ...
  export class Schema$FreeBusyRequestItem {
    /**
     * The identifier of a calendar or a group.
     */
    id?: string | null;
  }
  export class Schema$FreeBusyResponse {
    /**
  ...
  export class Schema$TimePeriod {
    /**
